        ...
        {phase === "initializing" && (
          ...
          >
            ...
            <p className="text-slate-400 text-sm">
              This may takes less than a minute
            </p>
          </motion.div>
        )}
            ...
            <AnimatePresence>
              {phase === "complete" && (
                ...
                >
                  <Button
                    onClick={onContinue}
                    className="w-full bg-blue-600 hover:bg-blue-700 text-white rounded-xl h-12 text-base shadow-lg shadow-blue-500/20"
                  >
                    Continue
                  </Button>
                </motion.div>
  ...
  return (
    ...
    >
      ...
      <div className="flex-1 min-w-0">
        <div className="font-medium text-slate-900 truncate">{scene.name}</div>
      ...
      <div className="shrink-0 w-6 flex justify-center items-center">
        {isLoading && <IosLoader className="w-5 h-5" />}
        {isComplete && (
          <motion.div
